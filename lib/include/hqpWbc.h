/**
 * @file HqpWbc.h
 * @brief declaration of the HqpWbc class, a subclass of abstract class wbc
 * @author Yan Xie
 * @date 2020-09-17
 * @version alpha
...
#ifndef WBC_HQPWBCSOLVER_H
#define WBC_HQPWBCSOLVER_H
...
/**
 * @class HqpWbc
 * @brief The HqpWbc class, a subclass derived from the abstract class Wbc, using the hierarchy-QP-based WBC algorithm.
