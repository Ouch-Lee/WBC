...
outLog_A_csv = '../local/compare/outLog.csv';
data_A = importdata(outLog_A_csv); 
logData_A = data_A(:,1:end);

logData_B = [];

outLog_B_csv = '../local/compare/outLog_B.csv';
data_B = importdata(outLog_B_csv); 
